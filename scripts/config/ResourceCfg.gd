...
# ResourceCfg: dátová definícia všetkých globálnych zdrojov pre top bar.
# - nerieši žiadnu logiku, iba názvy, kategórie, popisy a poradie v UI.
...
# Typ správania sa resource (ako ho budeme neskôr používať v logike).
enum ResourceType {
...
const RESOURCES: Dictionary = {
    ...
    &"earth_energy": {
        ...
        "can_go_negative": false, # skôr skóre, nie skladovaný resource
    },
    ...
    &"happiness": {
        ...
        "can_go_negative": false, # držíme 0..100
        "min_value": 0.0,
        "max_value": 100.0,
    },
